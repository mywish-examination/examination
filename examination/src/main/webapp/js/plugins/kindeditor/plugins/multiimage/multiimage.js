	...
	self.clickToolbar(name, function() {
		self.plugin.multiImageDialog({
			clickFn : function (list) {
				...
				/********对下面的K.each(list, function(i, data) 进行改进，使用下面的代码************************************/
				$("div.ke-item").find("img.ke-img").each(function(i){
					if (self.afterUpload) {
						self.afterUpload.call(self, $(this).attr("src"), $(this), 'multiimage');
					}
					self.exec('insertimage', $(this).attr("src"), $(this).attr("alt"), '', '', 0, "left");
				});
				/*********原来的方法******************************/
				/*
