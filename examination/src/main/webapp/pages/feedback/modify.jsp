        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form:form method="post" action="saveOrUpdate" modelAttribute="feedback" class="form-horizontal">
                        <form:hidden path="id"/>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">意见反馈内容:</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="userName" value="${feedback.userName}" data-id="${feedback.userId}">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-3">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="button" class="btn btn-white" onclick="window.location.href='${basePath}pages/feedback/list.jsp'" value="返回"/>
                            </div>
                        </div>
                    </form:form>
                </div>
