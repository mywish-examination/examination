...
<script>
    $(document).ready(function () {
        ...
        $("#schoolList").jqGrid({
            ...
            mtype: "POST",
            colNames: ['', '院校代码', '学校名称', '学校主类型', '学校子类型', '曾用名', '备注', '主管部门', '院校属性', '学历层次', '特色教育', '操作'],
            colModel: [
                {name: 'id', index: 'id', hidden: true},
                {name: 'educationalCode', index: 'educationalCode', width: '10%', sortable: false},
                ...
                {name: 'educationalInstitutionsAttributeName', index: 'educationalInstitutionsAttributeName', width: '10%', sortable: false},
                {name: 'educationLevelName', index: 'educationLevelName', width: '10%', sortable: false},
                {name: 'featureEducationalName', index: 'featureEducationalName', width: '10%', sortable: false},
